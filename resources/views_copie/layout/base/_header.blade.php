        ...
        @if (config('layout.header.self.display'))
            ...
            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                ...
                <div id="kt_header_menu" class="header-menu header-menu-mobile {{ Metronic::printClasses('header_menu', false) }}" {{ Metronic::printAttrs('header_menu') }}>
                    ...
                    @if (env('SERVER_TYPE')==1)<h1 class="text-warning">Serveur de pré production</h1>@endif
                    @if (env('SERVER_TYPE')==2)<h1 class="text-primary">Environnement de formation pour CRFPE</h1>@endif
                </div>
            </div>
