...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 ">
        <div class="card-title">
            <h3 class="card-label">Ressources
            </h3>
        </div>
        <div class="card-toolbar">
            ...
            <button class="btn btn-sm btn-icon btn-light-primary mr-2" data-toggle="tooltip" title="Rafraîchir"
                onclick="_reload_dt_ressources()"><i class="flaticon-refresh"></i></button>
            <button class="btn btn-sm btn-icon btn-light-primary" data-toggle="tooltip" title="Ajouter une ressource"
                onclick="_formRessource(0)"><i class="flaticon2-add-1"></i></button>
            <!--end::Button-->
        </div>
    </div>
    <div class="card-body">
        <!--begin::filter-->
        <x-filter-form type="Ressources" />
        <!--end::filter-->
        <!--begin: Datatable-->
        <table class="table table-bordered table-checkable" id="dt_ressources">
            <thead>
                <tr>
                    <th></th>
                    <th>Type</th>
...
<!--end::Card-->
<x-modal id="modal_form_ressource" content="modal_form_ressource_content" />
...
<!-- <script src="{{ asset('custom/js/list-ressources.js?v=1') }}"></script> -->
<script>
$.ajaxSetup({
    headers: {
...
_loadDatasForSelectOptions('typesSelect', 'RES_TYPES',0,1);
var dtUrl = '/api/sdt/ressources'; 
...
var _reload_dt_ressources = function() {
    $('#dt_ressources').DataTable().ajax.reload();
}
var _formRessource = function(row_id) {
    var modal_id = 'modal_form_ressource';
    var modal_content_id = 'modal_form_ressource_content';
    var spinner = '<div class="modal-body"><div class="spinner spinner-primary spinner-lg"></div></div>';
    $('#' + modal_id).modal('show');
    $('#' + modal_content_id).html(spinner);
    $.ajax({
        url: '/form/ressource/' + row_id,
        type: 'GET',
        dataType: 'html',
...
var form_id = 'formFilterRessources';
