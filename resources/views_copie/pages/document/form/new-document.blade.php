...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 ">
        <div class="card-title">
            <h3 class="card-label">Ajouter un nouveau document modèle
            </h3>
        </div>
    ...
    <div class="card-body">
        <form id="formDocument" class="form">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group mb-1">
                        <label>Header par defaut:</label>
                        <textarea class="form-control classic-editor" name="default_header" id="default_header"
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group mb-1">
                        ...
                        <textarea class="form-control classic-editor" name="custom_header" id="custom_header"
                            rows="3" required></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="form-group mb-1">
                        ...
                        <textarea class="form-control classic-editor" name="default_content" id="default_content"
                            rows="3" required></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="form-group mb-1">
                        ...
                        <textarea class="form-control classic-editor" name="custom_content" id="custom_content"
                            rows="3" required></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="form-group mb-1">
                        <label>Footer par défaut:</label>
                        <textarea class="form-control classic-editor" name="default_footer" id="default_footer"
                            rows="3" required></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="form-group mb-1">
                        ...
                        <textarea class="form-control classic-editor" name="custom_footer" id="custom_footer"
                            rows="3" required></textarea>
                    </div>
                </div>
            </div>
    ...
    submitHandler: function(form) {
        ...
        $.ajax({
            ...
            complete: function(resultat, statut) {
                _hideLoader('BTN_SAVE_DOCUMENT');
                setTimeout(function(){window.location.href="/admin/documents";},1500);
            }
        });
        return false;
    }
