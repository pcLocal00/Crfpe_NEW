                            ...
                            <tr>
                                <td class="header"
                                    ...
                                    <a target="_blank" rel="noopener noreferrer" href="https://solaris-crfpe.fr"
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 19px; font-weight: bold; text-decoration: none; display: inline-block;">{!! $htmlHeader !!}
                                    </a>
                                </td>
                            </tr>
                                            ...
                                            <tr>
                                                <td class="content-cell"
                                                    ...
                                                    <p
                                                        ...
                                                        {!! $htmlMain !!}</p>
                                                    {{-- <table class="action" role="presentation"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td
                                                                                                    ...
                                                                                                    <a target="_blank"
                                                                                                        ...
                                                                                                        href="https://solaris-crfpe.fr"
                                                                                                        class="button button-primary"
                                                                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #2d3748; border-bottom: 8px solid #2d3748; border-left: 18px solid #2d3748; border-right: 18px solid #2d3748; border-top: 8px solid #2d3748;">Visiter
                                                                                                        notre
                                                                                                        platform</a>
                                                                                                </td>
                                                                                            </tr>
                                            ...
                                            <tr>
                                                <td class="content-cell"
                                                    ...
                                                    <p
                                                        ...
                                                        © 2022 Plateforme de formation SOLARIS. All rights reserved.</p>
