...
<div class="float-right">
    <!-- Tree ADD BUTTON -->
    <button class="btn btn-light-primary" onclick="_formCertSession()" data-toggle="tooltip" title="" onclick="" data-original-title="Ajouter un niveau">
        ...
        <div class="col-lg-6">
            <div class="card card-custom card-border">
                <div class="card-body p-3">
                    <!-- Tree edit BUTTON -->
                    <button id="contacts_selection_edit" class="btn btn-light-primary" onclick="_formScore(false, 2)" data-toggle="tooltip" title="" data-original-title="Modifier les scores de la sélection" style="display: none;">
                ...
                <div class="card card-custom card-border">
                    <div style="min-height:0px;" class="card-header p-2">
                        ...
                        <div class="card-toolbar">
                            <button class="btn btn-sm btn-light-primary" data-toggle="tooltip" data-theme="dark" title="Affecter" data-original-title="Enregistrer"><i class="flaticon2-checkmark"></i> <span id="BTN_SAVE"></span></button>
                        </div>
                    </div>
                    <div class="card-body p-3">
                        <div class="form-group">
                            <label>Type d'affectation</label>
                            <select class="form-control form-control-sm" name="affectation_type" id="typesAffectationSelect">
...
<div class="float-right">
    <!-- Tree ADD BUTTON -->
    <button id="contacts_selection_edit" class="btn btn-light-primary" onclick="_formScore(false, 3)" data-toggle="tooltip" title="" data-original-title="Modifier les scores de la sélection" style="display: none;">
        <i class="flaticon2-add-1"></i> Modifier les scores
    </button>
    <!-- END ADD BUTTON -->
</div>
...
<script>
    ...
    function _formScore(schedulecontact_id = false, block_id=3) {
            ...
            var spinner = '<div class="modal-body"><div class="spinner spinner-primary spinner-lg"></div></div>';
            const schedulecontact_ids = schedulecontact_id ? ['SCONTACT' + schedulecontact_id] : $("#structure_temporelle_tree").jstree("get_selected");;
            $('#' + modal_id).modal('show');
            $('#' + modal_content_id).html(spinner);
            $.ajax({
