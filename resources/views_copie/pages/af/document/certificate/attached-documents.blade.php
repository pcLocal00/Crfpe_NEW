...
<div class="modal-body" id="modal_form_attached_documents_body">
    <div data-scroll="true" data-height="650">
        <input type="hidden" id="input_certificate_id" value="{{$certificate_id}}">
...
<script>
    ...
    $('#docs_dropzone').dropzone({
            url: "/form/upload/certificate/attached/documents", // Set the url for your upload script location
            ...
            sending: function(file, xhr, formData) {
                ...
                formData.append("certificate_id", $('#input_certificate_id').val());
            },
...
var cert_id=$('#input_certificate_id').val();
var dtCertUrl = '/api/sdt/certificate/attached/documents/'+cert_id; 
