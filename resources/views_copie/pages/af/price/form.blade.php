<div class="modal-header">
    <h5 class="modal-title" id="modal_price_af_title"><i class="flaticon-edit"></i> Ajouter des tarifs </h5>
...
<div class="modal-body" id="modal_price_af_body">
    <div data-scroll="true" data-height="600">
        ...
        <!-- end::form new price -->
        <form id="formAfRelPrice" class="form">
            <!-- begin::form -->
            @csrf
            <input type="hidden" name="af_id" value="{{ $af_id }}" />
            <div class="row">
                <div class="col-lg-12">
                    <!--begin: Datatable-->
...
var dtUrlSelectForPrices = '/api/sdt/select/prices/0/' + af_id;
