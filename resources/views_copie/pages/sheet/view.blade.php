...
<div class="row">
    ...
    <div class="col-md-6">
        <p>Crée le : <span class="label label-outline-warning label-pill label-inline">{{ $sheet->created_at->format('d/m/Y H:i') }}</span> - Modifiée le : <span class="label label-outline-warning label-pill label-inline">{{ $sheet->updated_at->format('d/m/Y H:i') }}</span></p>
    </div>
</div>
<div class="row mb-5">
    <div class="col-md-12">
...
<div class="alert alert-custom alert-outline-danger fade show mb-5" role="alert">
    ...
    <div class="alert-text">Aucune fiche technique n'est définie pour ce produit de formation</div>
</div>
@endif