    ...
    <div class="card-header flex-wrap border-0 ">
        ...
        <div class="card-toolbar">
            ...
            <button class="btn btn-sm btn-icon btn-light-primary" data-toggle="tooltip" title="Ajouter un paramétrage"
                onclick="_formEstimate(0,0,0)"><i class="flaticon2-add-1"></i></button>
            <!--end::Button-->
        </div>
    </div>
    <div class="card-body">
...
<!-- <script src="{{ asset('custom/js/list-estimates.js?v=1') }}"></script> -->
<script>
$.ajaxSetup({
    headers: {
...
//_generateAgreementEstimate
function _generateAgreementEstimate(estimate_id) {
    var successMsg="l'action à été effectuée avec succès.";
    var errorMsg="l'action à été échouée.";
    var swalConfirmTitle = "Êtes-vous sûr de bien vouloir générer une convention / contrat professionnelle?";
    var swalConfirmText = "";
    Swal.fire({
        ...
        if (result.value) {
            KTApp.blockPage();
            $.ajax({
                url: "/api/generate/agreement/"+ estimate_id,
                type: "GET",
                dataType: "JSON",
