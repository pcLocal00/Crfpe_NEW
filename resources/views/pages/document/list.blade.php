                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-1">
                        ...
                        <div class="card-toolbar">
                            <a href="/form/document/new" class="btn btn-sm btn-icon btn-light-primary mb-0"
                                data-toggle="tooltip" title="Ajouter un modèles de document"><i class="flaticon2-add-1"></i></a>
                        </div>
                    </div>
                    <!--end::Header-->
...
var _loadFormDocumentModel = function(document_model_id) {
    ...
    $.ajax({
        url: '/form/document/' + document_model_id,
        type: 'GET',
        dataType: 'html',
...
var _restore_default_value = function(row_id) {
    ...
    var swalConfirmTitle = "Êtes-vous sûr de bien vouloir supprimer le modèle par défaut?";
    var errorMsg = "Le modèle par défaut n\'a été restauré.";
    var urlRestore = "/api/restore/document/" + row_id;
    Swal.fire({
