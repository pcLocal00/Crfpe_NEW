            ...
            <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                ...
                <li class="nav-item mr-3">
                    <a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_3">
                        ...
                        <span class="nav-text font-size-lg" style="margin-left: 10px;">Modification de cette tâche</span>
                    </a>
                </li>
                <!--end::Item-->
            </ul>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="kt_user_edit_tab_3" role="tabpanel">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-9">
                                        <div class="col-8 checkbox-inline">
                                            <label class="checkbox">
                                                <input name="motivation" value="intern" type="radio" {{!$row->contact_id ? 'checked' : ''}}>
                                                <span></span>Tâche à réaliser en interne</label>
                                            <label class="checkbox">
                                                <input name="motivation" value="contact" type="radio" {{$row->contact_id ? 'checked' : ''}}>
                            ...
                            <div class="col-xl-6">
                                ...
                                <span class="switch switch-success switch-sm">
                                    ...
                                    <label>
                                        <input type="checkbox" {{$rightuser == "temoin" ? '' : 'disabled'}} name="yesnoread" id="yesnoread" {{$row->is_read == 1 ? 'checked' : ''}}>
                                        <span></span>
									</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card mb-8 contact-card" {!! !$row->contact_id ? 'style="display: none;"' : '' !!}>
                                ...
                                <div class="card mb-8">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid"
                                                    type="text" id="resume" name="resume" value="{{$row->title}}" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 checkbox-inline">
                                                <label class="checkbox">
                                                    <input name="task_object" value="glblaf" type="radio" {{$row->af_id ? 'checked' : ''}}
                                                        onchange="validateObject('glblaf')">
                                                    <span></span>AF</label>
                                                <label class="checkbox">
                                                    <input name="task_object" value="glblpf" type="radio" {{$row->pf_id ? 'checked' : ''}}
                                                        onchange="validateObject('glblpf')">
                                                    <span></span>PF</label>
                                                <label class="checkbox">
                                                    <input name="task_object" value="" type="radio" {{!$row->pf_id && !$row->af_id ? 'checked' : ''}}
                                                        onchange="validateObject('')">
                                        ...
                                        <div class="form-group row glblaf" {!! !$row->af_id ? 'style="display: none;"' : '' !!}>
                                        ...
                                        <div class="form-group row glblpf" {!! !$row->pf_id ? 'style="display: none;"' : '' !!}>
                                ...
                                <div class="card mb-8">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <textarea id="myTextarea" name="myTextarea">{{$row->description ?? ''}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Responsable</label>
                                            <div class="col-9">
                                            ...
                                            <div class="col-9">
                                                <div class="position-relative d-flex align-items-center"
                                                    ...
                                                    <input class="form-control form-control-solid ps-12 flatpickr-input"
														...
														value="{{ (new DateTime($row->start_date))->format('d/m/Y') }}"
													>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-9">
                                                <div class="position-relative d-flex align-items-center"
                                                    ...
                                                    <input class="form-control form-control-solid ps-12 flatpickr-input"
                                                        ...
                                                        name="due_date" type="text" readonly="readonly"
                                                        style="background-color: #F5F8FA; border-color: #F5F8FA; color: #5E6278;"
                                                        value="{{ (new DateTime($row->ended_date))->format('d/m/Y') }}"
													>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-9">
                                                <div class="position-relative d-flex align-items-center"
                                                    ...
                                                    <input class="form-control form-control-solid ps-12 flatpickr-input"
                                                        ...
                                                        style="background-color: #F5F8FA; border-color: #F5F8FA; color: #5E6278;"
														value="{{ (new DateTime($row->callback_date))->format('d/m/Y') }}"
													>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-8 checkbox-inline p-3">
                                                <label class="checkbox">
                                                    <input type="radio" name="rappelmode" class="rappelmode"
                                                        id="solaris" value="solaris" {{$row->callback_mode == 'solaris' ? 'checked' : ''}}>
                                                    <span></span>Solaris</label>
                                                <label class="checkbox">
                                                    <input type="radio" name="rappelmode" class="rappelmode"
                                                        id="email" value="email" {{$row->callback_mode == 'email' ? 'checked' : ''}}>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <select id="priorite" name="priorite"
                                                    ...
                                                    <option {{$row->priority == 'plus haute' ? 'selected' : ''}} value="plus haute">Plus haute</option>
                                                    <option {{$row->priority == 'haute' ? 'selected' : ''}} value="haute">haute</option>
                                                    <option {{$row->priority == 'bas' ? 'selected' : ''}} value="bas">Bas</option>
                                                    <option {{$row->priority == 'plus bas' ? 'selected' : ''}} value="plus bas">Plus bas</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-center">
                                        <div data-onloading="false" class="w-100">
                                            <button type="submit" data-loading-text="Création en cours..."
                                                ...
                                                id="BTN_SAVE">Enregistrer</button>
                                        </div>
...
@section('scripts')
    ...
    <script>     
       var is_read = 0;
        ...
        if($('#yesnoread').is(':checked')){
           is_read = 1
        }

        _loadcontacts(['rapporteur', 'responsable'], true, 0, [{{ $row->apporteur_id ?? 0}}, {{ $row->responsable_id ?? 0}}]);
        // _loadcontacts(['contact']);
        _loadentities('entity', {{ $row->entite_id ?? 0}}, {{ $row->contact_id ?? 0}});
        _loadafs('aflist', {{ $row->af_id ?? 0}});
        _loadpfs('pflist', {{ $row->pf_id ?? 0}});
        _getSource('source', {{ $row->source_id ?? 0}});
        _getType('type', {{ $row->type_id ?? 0}});
        _getMode('reponsemode', {{ $row->reponse_mode_id ?? 0}});
        _getEtat('etat', {{ $row->etat_id ?? 0}});
        ...
        function _loadcontacts(select_ids, intern = false, entity_id = 0, default_contact = 0) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    var array = response;
                    if (array != '') {
                        select_ids.map((select_id, index) => {
							const default_val = (typeof default_contact === 'object') ? default_contact[index] : default_contact;
                            for (i in array) {
                                $('#' + select_id).append("<option value='" + array[i].id + "' " + (
                                        default_val > 0 && array[i].id == default_val ? 'selected' : '') + ">" +
                                    array[i].name +
                                    "</option>");
                                $('#' + select_id).select2();
                                if (default_val > 0) {
        ...
        function _loadentities(select_id, selected_value = 0, default_contact = 0) {
            $('#' + select_id + ' option[value!=""]').remove();
                ...
                success: function(result) {
                    if (result != '') {
                        ...
                        if (selected_value != 0 && selected_value != '') {
                            $('#' + select_id).select2().val(selected_value).trigger('change', [default_contact]);
                        }
                    }
                }
            });
        ...
        function _loadafs(select_id, default_af = 0) {
            $.ajax({
                type: 'GET',
                url: '/api/sdt/listAfs',
                dataType: 'json',
                success: function(response) {
                    ...
                    if (array != '') {
                        for (i in array) {
                            ...
                            $('#' + select_id).append("<option value='" + array[i].id + "' " + (
                                        default_af > 0 && array[i].id == default_af ? 'selected' : '') + ">" + af_name +
                                "</option>");
                            $('#' + select_id).select2();
							if (default_af > 0) {
                                    $('#' + select_id).trigger('change');
        ...
        function _loadpfs(select_id, default_pf = 0) {
            $.ajax({
                type: 'GET',
                url: '/api/sdt/listPfs',
                dataType: 'json',
                success: function(response) {
                    ...
                    if (array != '') {
                        for (i in array) {
                            $('#' + select_id).append("<option value='" + array[i].id + "' " + (
                                        default_pf > 0 && array[i].id == default_pf ? 'selected' : '') + ">" + array[i].title +
                                "</option>");
                            $('#' + select_id).select2();
							if (default_pf > 0) {
                                    $('#' + select_id).trigger('change');
        ...
        function _getSource(select_id, default_val = 0) {
            $.ajax({
                type: 'GET',
                url: '/getSource',
                dataType: 'json',
                success: function(response) {
                    ...
                    if (array != '') {
                        for (i in array) {
                            $('#' + select_id).append("<option value='" + array[i].id + "' " + (
                                        default_val > 0 && array[i].id == default_val ? 'selected' : '') + ">" + array[i].name +
                                "</option>");
                            $('#' + select_id).select2();
							if (default_val > 0) {
                                    $('#' + select_id).trigger('change');
        ...
        function _getType(select_id, default_val = 0) {
            $.ajax({
                type: 'GET',
                url: '/getType',
                dataType: 'json',
        ...
        function _getMode(select_id, default_val = 0) {
            $.ajax({
                type: 'GET',
                url: '/getResponse',
                dataType: 'json',
        ...
        function _getEtat(select_id, default_val = 0) {
            $.ajax({
                type: 'GET',
                url: '/getEtat',
                dataType: 'json',
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.adresse != null) {
                        $('#contact_address').val(data.adresse.line_1?data.adresse.line_1:"" + '\n' + data.adresse.line_2?data.adresse.line_2:"" +
                            '\n' + data.adresse.line_3?data.adresse.line_3:"");
