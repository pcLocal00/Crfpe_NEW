...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 ">
        <div class="card-title">
            <h3 class="card-label">Tarifications
            </h3>
        </div>
        <div class="card-toolbar">
            ...
            <button class="btn btn-sm btn-icon btn-light-primary mr-2" data-toggle="tooltip" title="Rafraîchir"
                onclick="_reload_dt_prices()"><i class="flaticon-refresh"></i></button>
    ...
    <div class="card-body">
        <!--begin::filter-->
        <x-filter-form type="Prices" />
        <!--end::filter-->
        <!--begin: Datatable-->
        <table class="table table-bordered table-checkable" id="dt_prices">
            <thead>
                <tr>
                    <th></th>
                    <th>Titre</th>
...
<!--end::Card-->
<x-modal id="modal_form_price" content="modal_form_price_content" />
...
<!-- <script src="{{ asset('custom/js/list-prices.js?v=1') }}"></script> -->
<script>
$.ajaxSetup({
    headers: {
...
var _reload_dt_prices = function() {
    $('#dt_prices').DataTable().ajax.reload();
}
var _formPrice = function(row_id) {
    var modal_id = 'modal_form_price';
    var modal_content_id = 'modal_form_price_content';
    var spinner = '<div class="modal-body"><div class="spinner spinner-primary spinner-lg"></div></div>';
    $('#' + modal_id).modal('show');
    $('#' + modal_content_id).html(spinner);
    $.ajax({
        url: '/form/price/' + row_id,
        type: 'GET',
        dataType: 'html',
