                ...
                <div class="dropdown dropdown-inline mr-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                        ...
                        <ul class="navi flex-column navi-hover py-2">
                            <li class="navi-item">
                                <form id="getIntervSheet" method="GET" action="{{ url('/api/sdt/tdb/exportIntervenants') }}">
                                    <input type="hidden" value="" name="date_debut_int" id="date_debut_int"/>
                                    <input type="hidden" value="" name="date_fin_int" id="date_fin_int"/>
                                <a href="#" class="navi-link" id="downloadInterv">
...
<div class="row">
    <div class="col-lg-6">
        <div class="input-daterange input-group" id="filter_datepicker">
            <input type="text" class="form-control datatable-input" name="filter_start_int" id="filter_start_intervenants"
            ...
            <input type="text" class="form-control datatable-input" name="filter_end_int" id="filter_end_intervenants" value=""
...
$("#filter_start_etudiants").on("change", function() {
    ...
    $("#filter_start_intervenants").on("change", function() {
        var startDateValue = $(this).val();
        let start_elem = $("#date_debut_int");
        start_elem.val(startDateValue);
        // console.log("Selected Start Date: " + startDateValue);
        // You can perform further actions with the start date value here
    });
    ...
    $("#filter_end_intervenants").on("change", function() {
        var endDateValue = $(this).val();
        let end_elem = $("#date_fin_int");
        end_elem.val(endDateValue);
    ...
    $("#downloadInterv").click(function(event)
    {
        event.preventDefault();
        $("#getIntervSheet").submit();
    });
