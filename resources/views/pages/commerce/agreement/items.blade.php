    ...
    <table class="table">
        ...
        <tbody id="TBODY_TABLE_ITEMS">
            ...
            <tr class="">
                ...
                <th>
                    ...
                    <button type="button" class="btn btn-sm btn-clean btn-icon"
                        onclick="_formAgreementItem({{$item->id}},{{$item->agreement_id}})" title="Edition"><i
            ...
            <tr class="font-weight-boldest">
                ...
                <td colspan="2" class="text-success pr-0 pt-7 text-right">{{number_format($calcul['sous_total'],2)}} €</td>
                <td></td>
            </tr>
            ...
            <tr class="font-weight-boldest">
                ...
                <td>
                    @if(!$agreementHasInvoice)
                    <button type="button" class="btn btn-sm btn-clean btn-icon"
                        onclick="_formDiscount({{$item->agreement_id}})" data-toggle="tooltip"
