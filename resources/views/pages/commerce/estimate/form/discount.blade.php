    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <button type="button" onclick="$('#formDiscount').submit();" class="btn btn-sm btn-outline-primary"><i class="fa fa-check"></i> Valider la réduction<span id="BTN_SAVE_DISCOUNT"></span></button>
            </div>
        </div>
