...
@section('content')
    ...
    <x-modal id="modal_depot_devis" content="modal_depot_devis_content" />
    <x-modal id="modal_show_devis" content="modal_show_devis_content" />
    <x-modal id="modal_show_prestation" content="modal_show_prestation_content" />
    <x-modal id="modal_show_facture" content="modal_show_facture_content" />
    <x-modal id="modal_show_motif" content="modal_show_motif_content" />
    <x-modal id="modal_download_document" content="modal_download_document_content" />
