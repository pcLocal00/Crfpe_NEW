...
<form id="acceptPrestation" class="form" enctype="multipart/form-data">
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-sm btn-light-danger"onclick="_show_motif(<?php echo e($devis->id); ?>,<?php echo e($member_id); ?>)">
...
<?php /**PATH C:\Users\pc\OneDrive - Havet Digital\Bureau\src\resources\views/pages/formation/devis/two.blade.php ENDPATH**/ ?>