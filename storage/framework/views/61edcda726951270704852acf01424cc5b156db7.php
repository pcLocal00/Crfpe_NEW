<?php
$modal_title='Envoyer la facture par e-mail';
?>
<div class="modal-header">
    <h5 class="modal-title" id="modal_form_invoice_title"><i class="flaticon-edit"></i> <?php echo e($modal_title); ?> </h5>
...
<div class="modal-body" id="modal_form_invoice_body">
    <div data-scroll="true" data-height="600">
        <form id="formSendEmail" class="form">
            <?php echo csrf_field(); ?>
            <input type="hidden" id="INPUT_HIDDEN_INVOICE_ID" name="id" value="<?php echo e(($row)?$row->id:0); ?>" />
            <input type="hidden" name="type_id" value="<?php echo e(($row) ? $row->type_id : 0); ?>" />
            <input type="hidden" id="entitie_id" name="entitie_id" value="<?php echo e(($row)?$row->entitie_id:0); ?>" />
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="hidden" id="selected_contact_id" name="contact_id"
                            value="<?php echo e(($row)?$row->contact_id:0); ?>" />
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        value="<?php echo e($user); ?>" id="input_cc" />
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="reference">Object :<span class="text-danger">*</span> </label>
                            ...
                            value="Votre demande" id="" required/>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control form-control-sm" id="content_email" name="content" rows="5"><?php echo e($content); ?></textarea>
                    </div>
                </div>
            </div>
        </form>
...
function _loadContactsForSelectOptions(select_id, entity_id, selected_contact_id) {
    ...
    $.ajax({
        ...
        success: function(response) {
            var array = response;
            console.log('entity is'+entity_id)
            console.log(array)
...
</script><?php /**PATH C:\Users\pc\OneDrive - Havet Digital\Bureau\src\resources\views/pages/commerce/invoice/form/task.blade.php ENDPATH**/ ?>