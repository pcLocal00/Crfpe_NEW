...
<div class="modal-header">
    <h5 class="modal-title" id="modal_depot_devis_title"><i class="flaticon-edit"></i> Dépot de facture</h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <i aria-hidden="true" class="ki ki-close"></i>
    </button>
</div>
<!-- Form : begin -->
<form id="depotFacture" class="form" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
<script>
    $(document).ready(function() {
        $('#depotFacture').submit(function(e) {
            e.preventDefault();
...
<?php /**PATH C:\Users\pc\OneDrive - Havet Digital\Bureau\src\resources\views/pages/formation/devis/form_3.blade.php ENDPATH**/ ?>