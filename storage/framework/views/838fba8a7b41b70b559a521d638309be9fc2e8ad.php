        ...
        <?php if(config('layout.header.self.display')): ?>
            ...
            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                ...
                <div id="kt_header_menu" class="header-menu header-menu-mobile <?php echo e(Metronic::printClasses('header_menu', false)); ?>" <?php echo e(Metronic::printAttrs('header_menu')); ?>>
                    ...
                    <?php if(env('SERVER_TYPE')==1): ?><h1 class="text-warning">Serveur de pré production</h1><?php endif; ?>
                    <?php if(env('SERVER_TYPE')==2): ?><h1 class="text-primary">Environnement de formation pour CRFPE</h1><?php endif; ?>
                </div>
            </div>
...
<?php /**PATH C:\Users\pc\OneDrive - Havet Digital\Bureau\src\resources\views/layout/base/_header.blade.php ENDPATH**/ ?>