                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Type<span
                                                    ...
                                                    style="padding-left:2px; color:#DE350B;">*</span></label>
                                            <div class="col-9">
                                                <select id="type" name="type" class="form-control form-control-lg form-control-solid" required onclik="workflow()">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8 checkbox-inline">
                                                <label class="checkbox">
                                                    <input name="task_object" id="action_formation" value="glblaf"
                                                        type="radio" onchange="validateObject('glblaf')">
                                                    <span></span>AF</label>
                                                <label class="checkbox">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Superviseur<span
                                                    ...
                                                    style="padding-left:2px; color:#DE350B;">*</span></label>
                                            <div class="col-9">
                                                <!-- <input class="form-control form-control-lg form-control-solid mb-1" type="text" id="rapporteur" value="<?php echo e(auth()->user()->name); ?> <?php echo e(auth()->user()->lastname); ?>"> -->
                                                <select id="rapporteur" name="rapporteur"
                                                    ...
                                                    <!-- <option selected value="0"><?php echo e(auth()->user()->name); ?> <?php echo e(auth()->user()->lastname); ?></option>                                                         -->
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Envoyer un mail de
                                                création</label>
                                            <div class="col-8 checkbox-inline p-3">
                                                <label class="checkbox">
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Modal::class, ['id' => 'modal_dt_entities','content' => 'modal_dt_entities_content','dialogstyle' => 'max-width: 90%;']); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Modal::class, ['id' => 'modal_form_entitie','content' => 'modal_form_entitie_content']); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
                        ...
                        select_ids.map((select_id) => {
                            for (i in array) {
                                $('#' + select_id).append("<option value='" + array[i].id + "' " + (
                                        default_contact > 0 && array[i].id == default_contact ?
                                        'selected' : '') + ">" +
                                    array[i].name +
                                    "</option>");
                                $('#' + select_id).select2();
        ...
        $("form#addtask").submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(html, result) {
                    ...
                    let selected_entity = $('#entity').val();
                    let selected_contact = $('#contact').val();



                    // console.log('entity hna '+new_responsable_entity);
                    // console.log('contact hna '+selected_contact_id);
                    // console.log('entity 2 hna '+selected_entity);
                    // console.log('contact 2 hna '+selected_contact);



                    _loadContactsForSelectOptions('selectContacts', selected_entity, selected_contact);
        ...
        function workflow() {
            var af = document.getElementById('action_formation')
            var type = document.getElementById('type').value
            if (af.checked && type == 221) {
                var rapporteur = document.getElementById('rapporteur')
                var responsable = document.getElementById('responsable')
                var datedebut = document.getElementById('datedebut')
                var dateecheance = document.getElementById('dateecheance')
                var daterappel = document.getElementById('daterappel')
                rapporteur.disabled = true;
                responsable.disabled = true;
                datedebut.setAttribute("readonly", "readonly");
                datedebut.disabled = true
                dateecheance.disabled = true
                daterappel.disabled = true
            }
        }
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\OneDrive - Havet Digital\Bureau\src\resources\views/pages/task/addtask.blade.php ENDPATH**/ ?>