<input type="hidden" name="id" id="VIEW_INPUT_AF_ID_HELPER" value="<?php echo e($row->id); ?>">
<input type="hidden" id="AF_DEVICE_TYPE" value="<?php echo e($row->device_type); ?>">
    ...
    <div class="card card-custom">
        ...
        <div class="card-header py-3">
            ...
            <?php if(auth()->user()->roles[0]->code != 'FORMATEUR'): ?>
                <div class="card-toolbar">
                    <button onclick="_formAfSheet(<?php echo e($row->id); ?>,<?php echo e($af_sheet_id); ?>)"
                        class="btn btn-sm btn-icon btn-light-primary mr-2">
                        <i class="<?php echo e($af_sheet_id > 0 ? 'flaticon-edit' : 'flaticon2-add-1'); ?>"></i>
                    </button>
                    <button onclick="_IMPORT_PF_DEFAULT_SHEET(<?php echo e($row->id); ?>)"
        ...
        <div class="card-body">
            <p class="text-warning">Souhaitez vous importer la fiche technique configurées sur le produit de formation
                ...
                <button class="btn btn-sm btn-icon btn-light-primary mr-2" data-toggle="tooltip"
                    title="Importer la fiche technique" onclick="_IMPORT_PF_DEFAULT_SHEET(<?php echo e($row->id); ?>)"><i
                        ...
                        <div class="col-10">
                            ...
                            <select class="form-control select2" id="sessionsSelect" style="max-width:700px">
                                ...
                                <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($session['id']); ?>"><?php echo e($session['title']); ?>

                                        - <?php echo e($session['code']); ?></option>
...
<?php $component = $__env->getContainer()->make(App\View\Components\FilterForm::class, ['type' => 'SessionsGrid']); ?>
            ...
            <div id="collapseFeuillesPresence" class="collapse" data-parent="#accordionFeuillesPresence">
                <div class="card-body">
                    ...
                    <form id="formGenrateFeuillesPresence">
                        <input type="hidden" value="<?php echo e($row->id); ?>" name="af_id">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg-4">
                                <label>Date du:</label>
                                ...
                                <select class="form-control datatable-input" data-col-index="2" id="typesSelect"
                                    ...
                                    <?php if(isset($lieux)): ?>
                                        <?php $__currentLoopData = $lieux; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lieu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($lieu['name']); ?>"><?php echo e($lieu['name']); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                ...
                                <select class="form-control select2" id="membersSelectFilter" name="member_id"
                                    ...
                                    <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($m->id); ?>">
                                            <?php echo e($m->contact->firstname . ' ' . $m->contact->lastname); ?>
...
<?php if($viewtype == 'inscriptions'): ?>
    ...
    <link href="<?php echo e(asset('custom/css/custom.css')); ?>" rel="stylesheet" type="text/css" />
    <?php if (isset($component)) { $__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Modal::class, ['id' => 'modal_form_contact','content' => 'modal_form_contact_content']); ?>
...
<?php if($viewtype == 'groups'): ?>
    ...
    <?php if (isset($component)) { $__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Modal::class, ['id' => 'modal_form_group','content' => 'modal_form_group_content']); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Modal::class, ['id' => 'modal_form_groupment','content' => 'modal_form_groupment_content']); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Modal::class, ['id' => 'modal_affectation_group','content' => 'modal_affectation_group_content']); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Modal::class, ['id' => 'modal_affectation_groupment','content' => 'modal_affectation_groupment_content']); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php if($viewtype == 'schedulecontacts'): ?>
    <!--begin::Card-->
    <div class="card card-custom">
        <!--begin::Header-->
        <div class="card-header py-3">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <?php if($count <= 3): ?>
                    <button type="button" onclick="formDepotDevis()" class="btn btn-sm btn-icon btn-light-primary mr-2">
                        <i class="flaticon2-add-1"></i>
                    </button>
                <?php endif; ?>
                ...
                <button class="btn btn-sm btn-icon btn-light-primary mr-2" data-toggle="tooltip"
                    onclick="resfreshJSTreeSchedulecontacts()" data-original-title="Rafraîchir">
                    <i class="flaticon-refresh"></i>
                </button>
                ...
                <!--end::Button-->
                    <?php if(auth()->user()->roles[0]->code != 'FORMATEUR'): ?>
                    <button class="btn btn-sm btn-icon btn-light-primary" data-toggle="tooltip" title=""
                        onclick="_formRemuneration(<?php echo e($row->id); ?>,0)"
                ...
                <div class="card-body">
                    <form id="formFilterScheduleContacts">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label>Session :</label>
                                <select class="form-control select2" id="sessionsSelectFilter" name="session_id"
                                    style="width:100%;">
                                    <option value="0">Toutes les sessions</option>
                                    <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($session['id']); ?>"><?php echo e($session['title']); ?>
                            ...
                            <div class="col-md-6">
                                <label>Groupe :</label>
                                <select class="form-control select2" data-col-index="2" id="groupesSelectFilter"
                                    name="group_id" style="width:100%;"></select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <label>Étudiant :</label>
                                <select class="form-control select2" id="membersStudentSelectFilter" name="member_id"
                                    style="width:100%;">
                                    <option value="0">Tous les étudiants</option>
                                    <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($m->id); ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control select2" id="membersFormersSelectFilter" name="inter_id"
                                    style="width:100%;">
                                    <option value="0">Tous les intervenant</option>
                                    <?php $__currentLoopData = $intervenant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($m->id); ?>">
                                            <?php echo e($m->contact->firstname . ' ' . $m->contact->lastname); ?>
...
<script type="text/javascript">
    ...
    function formDepotDevis() {
        var af_id = $("input[name='af_id']").val();
        var modal_id = 'modal_depot_devis';
        var modal_content_id = 'modal_depot_devis_content';
        var spinner = '<div class="modal-body"><div class="spinner spinner-primary spinner-lg"></div></div>';
        $('#' + modal_id).modal('show');
        $('#' + modal_content_id).html(spinner);
        $.ajax({
            url: '/view/depot/devis/' + af_id,
            type: 'GET',
            dataType: 'html',
            success: function(html, status) {
                $('#' + modal_content_id).html(html);
...
<?php if($viewtype == 'certifications'): ?>
    <div class="card card-custom">
        <!--begin::Header-->
        <div class="card-header py-3">
            <div class="card-title align-items-start flex-column">
...
<?php if($viewtype == 'tarification'): ?>
    ...
    <div class="card card-custom">
        ...
        <div class="card-header py-3">
            ...
            <div class="card-toolbar">
                <button onclick="_formAfRelPrice(<?php echo e($row->id); ?>)"
                    class="btn btn-sm btn-icon btn-light-primary mr-2">
                    <i class="flaticon2-add-1"></i>
                </button>
                ...
                <button class="btn btn-sm btn-icon btn-light-danger" data-toggle="tooltip"
                    title="Supprimer une selection" onclick="_deleteAfRelPrice(0, <?php echo e($row->id); ?>)"><i
        ...
        <div class="card-body">
            <p class="text-warning">Souhaitez vous importer les tarifs configurées sur le produit de formation
                racine?
                <button class="btn btn-sm btn-icon btn-light-primary mr-2" data-toggle="tooltip"
                    title="Importer les tarifs" onclick="_IMPORT_PF_PRICES(<?php echo e($row->id); ?>)"><i
                        class="flaticon-download"></i></button>
            </p>
            <!--begin: Datatable-->
    ...
    <?php if (isset($component)) { $__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Modal::class, ['id' => 'modal_price_af','content' => 'modal_price_af_content']); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php if($viewtype == 'intervenants'): ?>
    ...
    <?php if (isset($component)) { $__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Modal::class, ['id' => 'modal_form_afintervenant','content' => 'modal_form_afintervenant_content']); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
    ...
    <script>
        ...
        function _selection_document(devis_id, member_id , type) {
            if(type == 1){
                var modal_id = 'modal_show_devis';
                var modal_content_id = 'modal_show_devis_content';
            } else if(type == 2){
                var modal_id = 'modal_show_prestation';
                var modal_content_id = 'modal_show_prestation_content';
            } else if(type == 3){
                var modal_id = 'modal_show_facture';
                var modal_content_id = 'modal_show_facture_content';
            }
            var spinner = '<div class="modal-body"><div class="spinner spinner-primary spinner-lg"></div></div>';
            $('#' + modal_id).modal('show');
            $('#' + modal_content_id).html(spinner);
            $.ajax({
                url: '/view/show/devis/' + devis_id + '/' + member_id+'/'+ type,
                type: 'GET',
                dataType: 'html',
                success: function(html, status) {
                    $('#' + modal_content_id).html(html);
    ...
    <script>
        ...
        setInterval(function() {
            var button = document.getElementById('envelopeButton');
            var button_2 = document.getElementById('envelopeButtontwo');
            var button_3 = document.getElementById('envelopeButtonThree');
            if (button) {
                button.classList.toggle('flash');
            }else if(button_2){
                button_2.classList.toggle('flash');
            }else if(button_3){
                button_3.classList.toggle('flash');
            }
        }, 2000);
    </script>
<?php endif; ?>

<?php if($viewtype == 'ressources'): ?>
    <!--begin::Card-->
    <div class="card card-custom">
        <!--begin::Header-->
        <div class="card-header py-3">
    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <?php if(auth()->user()->roles[0]->code != 'FORMATEUR'): ?>
                <ul class="nav nav-tabs nav-tabs-line mb-5">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#tab_doc_1"
                            onclick="_load_documents_tab(1)">
                            <span class="nav-icon"><i class="flaticon-notes"></i></span>
    ...
    <div class="card card-custom">
        ...
        <div class="card-header py-3">
            ...
            <div class="card-toolbar">
                ...
                <button class="btn btn-sm btn-icon btn-light-primary" data-toggle="tooltip"
                    title="Ajouter une période de stage" onclick="_formStage(0,<?php echo e($row->id); ?>)"><i
                        class="flaticon2-add-1"></i></button>
                <!--end::Button-->
            </div>
        </div>
        ...
        <div class="card-body">
            <!--begin::filter-->
            <?php if (isset($component)) { $__componentOriginal1671c564e6c9e82f0a2e15e0388d7cfb953fd2ae = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\FilterForm::class, ['type' => 'Stages']); ?>
<?php $component->withName('filter-form'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Modal::class, ['id' => 'modal_form_stage','content' => 'modal_form_stage_content']); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Modal::class, ['id' => 'modal_form_stageItem','content' => 'modal_form_stageItem_content']); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php unset($__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c); ?>
<?php endif; ?>
    <script src="<?php echo e(asset('custom/js/list-stages.js?v=3')); ?>"></script>
<?php endif; ?>

<?php if($viewtype == 'proposals'): ?>
    <div class="card card-custom">
        <!--begin::Header-->
        <div class="card-header py-3">
            <div class="card-title align-items-start flex-column">
            ...
            <div class="card-toolbar">
                ...
                <button class="btn btn-sm btn-icon btn-light-primary" data-toggle="tooltip"
                    title="Ajouter une période de stage" onclick="_formStageProposal(0,<?php echo e($row->id); ?>)"><i
                        class="flaticon2-add-1"></i></button>
                <!--end::Button-->
            </div>
        </div>
        ...
        <div class="card-body">
            <!--begin::filter-->
            <?php if (isset($component)) { $__componentOriginal1671c564e6c9e82f0a2e15e0388d7cfb953fd2ae = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\FilterForm::class, ['type' => 'StageProposals']); ?>
<?php $component->withName('filter-form'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Modal::class, ['id' => 'modal_form_stage_proposal','content' => 'modal_form_stage_proposal_content']); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Modal::class, ['id' => 'modal_form_stage_proposal_attachment','content' => 'modal_form_stage_proposal_attachment_content']); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php unset($__componentOriginal2bcebcb49cbd37095816ed3d3b22a3f8992f805c); ?>
<?php endif; ?>
    <!-- <script src="<?php echo e(asset('custom/js/list-stage-proposals.js?v=1')); ?>"></script> -->
    <script>
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php endif; ?>
<?php /**PATH C:\Users\pc\OneDrive - Havet Digital\Bureau\src\resources\views/pages/af/construct/view.blade.php ENDPATH**/ ?>